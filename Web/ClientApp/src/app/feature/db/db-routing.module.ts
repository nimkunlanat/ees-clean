...
import { dbrt02Detail, employees, dbrt02master } from './dbrt02/dbrt02.resolver';
...
import { provinces , districts, dbrt04master, subdistricts } from './dbrt04/dbrt04.resolver';
...
const routes: Routes = [
  ...
  { path: 'dbrt02/detail', component: Dbrt02DetailComponent, title: 'Employee', resolve: { dbrt02Detail, dbrt02master }, canDeactivate: [CanDeactivate], data: { code: 'dbrt02' } },
