...
import { Assessment, DocumentApproveds, etdt01, etdt01master, Skillmatrix} from './etdt01/etdt01.resolver';
...
const routes: Routes = [
  { path: 'etdt01', component: Etdt01Component, title: 'etdt01', resolve : {etdt01 , DocumentApproveds} , data : { code : 'etdt01'}},
  { path: 'etdt01/assessment', component: Etdt01AssessmentComponent, title: 'AssessmentForm', resolve : {Assessment, etdt01master} , data : { code : 'etdt01'}},
  { path: 'etdt01/assessment/skill', component: Etdt01SkillComponent, title: 'SkillForm', resolve : {Skillmatrix , etdt01master} , data : { code : 'etdt01'}},
